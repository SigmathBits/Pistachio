-- Taken from Hazel (https://github.com/TheCherno/Hazel/blob/49da3c1e08245feb5b978269119f50b0873dc9d1/vendor/premake/premake_customization/solution_items.lua)
-- For some reason we need to do this to make the SandboxProject? (premake5 sucks more than I thought, I guesss)
